...
import {
  ...
  makeFeedRateChart,
  makeGrowthRateChart,
  makeCarbonBalanceChart,
  makeOURDecompositionChart,
  makeSupplementComparisonChart,
} from './chart-configs'
      ...
      evidence: [
        {
          ...
          chartConfig: makeGrowthRateChart(),
        },
        {
          type: 'table',
      ...
      evidence: [
        {
          ...
          chartConfig: makeCarbonBalanceChart(),
        },
        {
          type: 'text',
      ...
      evidence: [
        {
          ...
          chartConfig: makeSupplementComparisonChart(),
        },
        {
          type: 'table',
      ...
      evidence: [
        {
          ...
          chartConfig: makeOURDecompositionChart(),
        },
        {
          type: 'text',
