...
import { FlaskConical, FlaskConicalOff, TrendingUp, TrendingDown, Target, CircleAlert, ArrowRight } from 'lucide-react'
      ...
      <section className='team'>
        ...
        <div className='team_grid'>
          ...
          <a href="https://www.linkedin.com/in/shilpa-nargund/" target="_blank" rel="noopener noreferrer" className='team_card'>
            <div className='team_card_image'>
              <img src="/assets/Landing_assets/team/shilpa.png" alt="Shilpa Nargund" />
            </div>
            <div className='team_card_content'>
